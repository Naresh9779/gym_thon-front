...
### Database
- [x] Cleaned (only admin account remains)
- [x] Default password set (change on first login!)
...
- Password: Configured in ADMIN_PASSWORD (change immediately!)
...
- [AUTOMATIC_PLAN_GENERATION.md](../backend/AUTOMATIC_PLAN_GENERATION.md) - Automatic generation docs
